...
Criamos uma constante com o nome de mongoose e informamos que ela requer o módulo chamado de mongoose - Em tempo! Por quê criamos uma contante (const) e não uma variável (var)? - A  resposta desta pergunta deixaremos para o Imediato e Oficial da ciências Sr. SuissaSpock
...
Criamos uma constante com o nome de mongoose e informamos que ela requer o módulo chamado de mongoose.
